...
public class BoolToVisConverter : IValueConverter
{
    public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
    {
        var vis = value is bool b && b ? Visibility.Visible : Visibility.Collapsed;
...
/// <summary>Visible only when the string is non-empty — used to hide status/message lines that take no space when blank.</summary>
